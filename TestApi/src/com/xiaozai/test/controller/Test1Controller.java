...
@Api(hidden=true, value="/t/s", description="", position=-1)
@Controller("/t")
public class Test1Controller {

	@ApiOperation(value="查询用户")
	@RequestMapping(
			value = "queryUserById1", method = RequestMethod.GET, produces = "application/json; charset=utf-8")
	public void queryUserById1(@RequestParam(required=false) String userId, HttpServletResponse response){
		System.out.println("request param:"+userId);
		String responseStr = "/queryUserById response: 测试成功！" ;
		writeObject(responseStr, response);
	}
	
	@RequestMapping(value = "updateStudent1", method = RequestMethod.POST, produces = "application/json; charset=utf-8")
	...
	@RequestMapping(value="testParamObj1", method=RequestMethod.POST)
	@ResponseBody
